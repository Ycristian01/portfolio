...
export const projects: Project[] = [
  ...
  {
    name: "Sistema Brilla",
    employer: "Gases del Caribe",
    year: "2022 – 2024",
    description:
      "Web platform for non-banking credits paid through gas bills. Led the Rails→NestJS migration, built PDF digital signing, and reduced page-load time by 30%.",
